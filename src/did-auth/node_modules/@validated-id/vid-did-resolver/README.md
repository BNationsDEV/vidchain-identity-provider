# Validated ID DID Resolver

This library is intended to use Validated ID Ethereum-based addresses as fully self managed [Decentralized Identifiers](https://w3c-ccg.github.io/did-spec/#decentralized-identifiers-dids) and wrap them in a [DID Document](https://w3c-ccg.github.io/did-spec/#did-documents)
...
To encode a DID for an VID address, simply prepend `did:vid:`

eg:

`did:vid:0xf3beac30c498d9e26865f34fcaa57dbb935b0d74`
...
```js
{
  ...
  id: 'did:vid:0xb9c5714089478a327f09197987f16f9e5d936e8a',
  publicKey: [{
       id: 'did:vid:0xb9c5714089478a327f09197987f16f9e5d936e8a#owner',
       type: 'Secp256k1VerificationKey2018',
       owner: 'did:vid:0xb9c5714089478a327f09197987f16f9e5d936e8a',
       ethereumAddress: '0xb9c5714089478a327f09197987f16f9e5d936e8a'}],
  authentication: [{
       type: 'Secp256k1SignatureAuthentication2018',
       publicKey: 'did:vid:0xb9c5714089478a327f09197987f16f9e5d936e8a#owner'}]
}
```
...
```js
{
  id: "did:vid:0xf3beac30c498d9e26865f34fcaa57dbb935b0d74#delegate-1",
  type: "Secp256k1VerificationKey2018",
  owner: "did:vid:0xf3beac30c498d9e26865f34fcaa57dbb935b0d74",
...
A `DIDAttributeChanged` event for the identity `0xf3beac30c498d9e26865f34fcaa57dbb935b0d74` with the name `did/svc/HubService` and value of the url `https://hubs.ethr.me` hex encoded as `0x68747470733a2f2f687562732e75706f72742e6d65` generates a `Service` entry like this:

```js
{
  type: "HubService",
  serviceEndpoint: "https://hubs.ethr.me"
}
```
...
import getResolver from "vid-did-resolver";

// You can set a rpc endpoint to be used by the web3 provider
// You can also set an address for your own vid-did-registry contract
...
const vidDidResolver = getResolver(providerConfig);
const didResolver = Resolver(vidDidResolver);

didResolver
  .resolve("did:vid:0xf3beac30c498d9e26865f34fcaa57dbb935b0d74")
